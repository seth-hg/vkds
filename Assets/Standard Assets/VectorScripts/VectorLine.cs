// Version 2.0
// 漏2012 Starscene Software. All rights reserved. Redistribution of source code without permission not allowed.
...
public class VectorLine {
	...
	public Material material {
		get {return vectorObject.GetComponent<Renderer>().material;}
		set {vectorObject.GetComponent<Renderer>().material = value;}
	}
	bool m_active = true;
	public bool active {
		get {return m_active;}
		set {
			m_active = value;
			if (vectorObject != null) {
				vectorObject.GetComponent<Renderer>().enabled = m_active;
			}
		}
	}
